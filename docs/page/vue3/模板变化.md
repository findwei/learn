<!--
 * @Author: 钱巍
 * @Date: 2021-10-07 21:36:13
 * @LastEditTime: 2021-10-07 21:48:55
 * @LastEditors: 钱巍
 * @Description: 
 * @FilePath: \vue_heimaohuie:\learn\docs\page\vue3\模板变化.md
 * 没有理想，何必远方。
-->
#
# v-model
...
- **允许自定义`v-model`修饰符**
  ...
  <img src="https://raw.githubusercontent.com/findwei/learnImages/main/vue3/20201008163022.png" alt="image-20201008163021918" style="zoom:50%;" />
