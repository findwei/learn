...
1. 什么是虚拟dom？
   ...
   <img src="/page/vue/img/20210225140726.png" alt="image-20210225140726003" style="display:block;" align="left" />
...
3. 虚拟dom是如何转换为真实dom的？
   ...
   **这样一来，就保证了对真实dom达到最小的改动。**
   ...
   <img src="/page/vue/img/20210225144108.png" alt="image-20210225144108143" style="zoom:33%;" align="left" />
...
4. 模板和虚拟dom的关系
   ...
   1. 将模板字符串转换成为`AST`
   2. 将`AST`转换为`render`函数 -> 页面运行时执行render()返回的是vNode
